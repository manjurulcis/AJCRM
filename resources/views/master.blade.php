...
<head>
    ...
    <!--[if lt IE 9]>
        <script src="../assets/{{URL::asset('js')}}/ie8-responsive-file-warning.js"></script>
        <![endif]-->
...
<body class="nav-md">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a href="{{URL::to('/')}}" data-toggle="tooltip" data-placement="top" title="Logout">
    ...
    <!-- chart js -->
    <script src="{{URL::asset('js')}}/chart{{URL::asset('js')}}/chart.min.js"></script>
